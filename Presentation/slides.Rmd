...
```{r echo=F}
plot_data_with_decision_boundaries(noisy, sim_results_me)
```

## What about a SOFT CLASIFIER?

This graph sucks.

```{r echo=F}
# The code kind of sucks too.
classified <- soft_classify_set(sim_results_me, noisy)
...
## What about a DIFFERENT WAY OF VISUALIZING A SOFT CLASSIFIER?

This might be even worse.

```{r echo=F}
plot_soft_classifier_raster(sim_results_me)
```
