...
In the future, we would be interested in exploring how this pipeline translates to a clustering task, where performance measures are relatively nebulous. In addition, we are interested in using this pipeline to potentially improve the performance of a classifier through ensemble learning methods.
